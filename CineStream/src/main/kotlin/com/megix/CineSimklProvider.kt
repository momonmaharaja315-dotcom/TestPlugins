...
class CineSimklProvider: MainAPI() {
    ...
    override suspend fun loadLinks(
        ...
        runAllAsync(
            ...
            { invokeTorrentio(res.imdbId, res.season, res.episode, callback) },
            { if (!res.isBollywood) invokeHindmoviez("HindMoviez", res.id, res.season, res.episode, callback) },
            // { if (res.isBollywood) invokeHindmoviez("JaduMovies", res.id, res.season, res.episode, callback) },
