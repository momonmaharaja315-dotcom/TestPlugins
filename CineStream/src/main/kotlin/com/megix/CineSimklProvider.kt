...
class CineSimklProvider: MainAPI() {
   ...
   private suspend fun extractImdbInfo(
    ...
    fun convertToLocalTime(dateTimeWithOffset: String? = null): String? {
        if(dateTimeWithOffset == null) return null
        // Parse the input string with offset
        val sdf = SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ssXXX", Locale.getDefault())
        val date = sdf.parse(dateTimeWithOffset) ?: return null
