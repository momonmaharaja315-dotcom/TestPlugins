...
class CineSimklProvider: MainAPI() {
    ...
    override suspend fun loadLinks(
        ...
        runAllAsync(
            ...
            //{ if (!res.isBollywood || !res.isAnime) invokeMoviesflix("Moviesflix", moviesflixAPI, res.imdbId, res.season, res.episode, subtitleCallback, callback) },
            //{ if (res.isBollywood) invokeMoviesflix("Hdmoviesflix", hdmoviesflixAPI, res.imdbId, res.season, res.episode, subtitleCallback, callback) },
