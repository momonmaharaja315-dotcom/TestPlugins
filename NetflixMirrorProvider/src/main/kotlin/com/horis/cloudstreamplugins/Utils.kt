...
suspend fun bypass(mainUrl : String): String {
    ...
    val verifyUrl = app.get("https://raw.githubusercontent.com/SaurabhKaperwan/Utils/refs/heads/main/NF.json").parsed<VerifyUrl>().url.replace("###", addhash)
    val res = app.get("$verifyUrl&t=${APIHolder.unixTime}")
    delay(5000)
