...
class BollyflixProvider : MainAPI() { // all providers must be an instance of MainAPI
    ...
    override val mainPage = mainPageOf(
        "${basemainUrl ?: mainUrl}/" to "Home",
        "${basemainUrl ?: mainUrl}/movies/bollywood/" to "Bollywood Movies",
        "${basemainUrl ?: mainUrl}/movies/hollywood/" to "Hollywood Movies",
        "${basemainUrl ?: mainUrl}/web-series/ongoing-series/" to "Ongoing Series",
        "${basemainUrl ?: mainUrl}/anime/" to "Anime"
    )
