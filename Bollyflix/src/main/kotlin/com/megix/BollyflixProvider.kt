...
class BollyflixProvider : MainAPI() { // all providers must be an instance of MainAPI
    override var mainUrl = "https://bollyflix.phd"
    ...
    override suspend fun load(url: String): LoadResponse? {
        ...
        if(tvtype == "series") {
            ...
            buttons.mapNotNull { button ->
                ...
                var decodeUrl = bypass(id)
                decodeUrl = if(decodeUrl == "") null else decodeUrl
                val seasonDoc = app.get(decodeUrl ?: return@mapNotNull).document
