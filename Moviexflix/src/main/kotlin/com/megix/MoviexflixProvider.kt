...
open class MoviezflixProvider : MainAPI() { // all providers must be an instance of MainAPI
    override var mainUrl = "https://themoviezflix.cn.com"
    ...
    override suspend fun getMainPage(
        ...
        val home = document.select("div#content_box > article").mapNotNull {
            it.toSearchResult()
        }
    ...
    override suspend fun search(query: String): List<SearchResponse> {
        ...
        for (i in 1..25) {
            ...
            val results = document.select("div#content_box > article").mapNotNull { it.toSearchResult() }
