...
class CinemaluxeProvider : MainAPI() { // all providers must be an instance of MainAPI
    ...
    companion object {
        val basemainUrl: String? by lazy {
            runBlocking {
                try {
                    val mainUrl = "https://raw.githubusercontent.com/SaurabhKaperwan/Utils/refs/heads/main/urls.json"
                    val json = app.get(mainUrl).text
                    val data = parseJson<BaseUrl>(json)
                    data.cinemaluxe
                } catch (e: Exception) {
                    null
                }
    ...
    override val mainPage = mainPageOf(
        ...
        "${basemainUrl ?: mainUrl}/genre/hollywood/page/" to "Hollywood Movies",
        "${basemainUrl ?: mainUrl}/genre/south-indian-movies/page/" to "South Indian Movies",
        "${basemainUrl ?: mainUrl}/genre/hollywood-tv-show/page/" to "Hollywood TV Shows",
        "${basemainUrl ?: mainUrl}/genre/bollywood-tv-show/page/" to "Bollywood TV Shows",
        "${basemainUrl ?: mainUrl}/genre/anime-tv-show/page/" to "Anime TV Shows",
    )
